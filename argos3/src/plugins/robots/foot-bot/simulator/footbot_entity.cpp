...
//   static const Real BODY_HEIGHT                = 0.106899733f;
    ...
    //divide by DISTANCE_RATIO_FOOTBOT_KREMBOT in order to sense the distance in the same proportion
    static const Real PROXIMITY_SENSOR_RING_RANGE           = 0.2551f * DISTANCE_RATIO_FOOTBOT_KREMBOT;
