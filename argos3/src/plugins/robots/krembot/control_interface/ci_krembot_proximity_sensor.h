...
namespace argos {
   class CCI_KrembotProximitySensor;
}
...
namespace argos {
   ...
   class CCI_KrembotProximitySensor : public CCI_Sensor {
   ...
   public:
       ...
       * Class constructor
       */
      CCI_KrembotProximitySensor();

      /**
       * Class destructor
       */
      virtual ~CCI_KrembotProximitySensor() {}
   ...
   std::ostream& operator<<(std::ostream& c_os, const CCI_KrembotProximitySensor::SReading& s_reading);
   std::ostream& operator<<(std::ostream& c_os, const CCI_KrembotProximitySensor::TReadings& t_readings);
